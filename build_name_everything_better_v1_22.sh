...
"$PYINSTALLER_BIN" \
  --noconfirm \
  --windowed \
  --name "Name Everything Better V1_22" \
  --icon "$ROOT_DIR/assets/vod_name_builder_v1_7_icon.png" \
  --hidden-import tkinter \
  name_everything_better_combined.py

echo "Build complete: $ROOT_DIR/dist/Name Everything Better V1_22.app"
