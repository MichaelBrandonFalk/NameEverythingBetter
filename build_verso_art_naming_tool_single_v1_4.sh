...
"$PYINSTALLER_BIN" \
  --noconfirm \
  --windowed \
  --name "Verso - Art Naming Tool - Single V1_4" \
  --icon "$ROOT_DIR/assets/verso_art_naming_tool_v1_5_icon.png" \
  --hidden-import tkinter \
  art_name_helper_single.py

echo "Build complete: $ROOT_DIR/dist/Verso - Art Naming Tool - Single V1_4.app"
